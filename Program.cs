...
namespace CalculatingCostShirts
{
    public class Program
    {
        ...
        public static string sColorShirt, sKindOfShirt, sManyShirts = string.Empty;
        public static int iManyShirts; // this variable receive the number of shirts
        public static double dTotal; // this variable calculate the total price of shirts
        ...
        /// <summary>
        /// Method to ask questions to user
        /// </summary>
        public static void MakeQuestions()
        {
            ...
            iManyShirts = int.Parse(sManyShirts);
        }
        ...
        public static void Main(string[] args)
        {
            ...
            while (sYesNo.ToUpper() == "Y")
            {
                ...
                Console.WriteLine("Press Y (es) for new order OR press ANY key to finish!");
